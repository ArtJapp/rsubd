...
public class ToolbarConfig {
    ...
    /**
     * Set back action on navigation button
     *
     * @param isEnable set action or not
     */
    public ToolbarConfig enableBackAction(boolean isEnable) {
        isBackEnable = isEnable;
        return this;
    }
    ...
    /**
     * Set the title color of this toolbar
     *
     * @param color resource of title color
     */
    public ToolbarConfig setTitleTextColor(@ColorRes int color) {
     ...
     */
    public ToolbarConfig setToolbarBackgroundColor(@ColorInt int color) {
     ...
     */
    public ToolbarConfig setHomeAsUpIndicatorColor(@ColorRes int color) {
    ...
    private void configToolbar(Toolbar toolbar) {
        ...
        configToolbarTitleColor(toolbar);
    }
    ...
    private void configToolbarTitleColor(Toolbar toolbar) {
        if (toolbar != null && titleColorId != -1) {
            toolbar.setTitleTextColor(ContextCompat.getColor(activity, this.titleColorId));
        }
    }
}